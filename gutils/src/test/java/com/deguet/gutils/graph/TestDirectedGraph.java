...
public class TestDirectedGraph{	
	...
	public void testRestrictToUseless(){
		...
		Assert.assertEquals("Resteindre ne fait rien si on ne restreint pas ",cycle, restr);
	}
	...
	public void testRestrictTo(){
		...
		Assert.assertEquals("Resteindre ne fait rien si on ne restreint pas ",cycle.vertices().size()-1, restr.vertices().size());
	}
	...
	public static void test2(String prefix, DGraph m, DGraph r){
		...
		Assert.assertEquals("Get edge is the same ", r.getEdge(11, 9), m.getEdge(11, 9));
